...
async def query_user_memory_core(db: Prisma, user_id: str) -> tuple[int, str]:
...
async def query_user_memory(user_id: str) -> tuple[int, str]:
	async with Prisma() as db:
		return await query_user_memory_core(db, user_id)
